...
class EdxOrderPlacementMixin(OrderPlacementMixin):
    ...
    def handle_payment(self, response, basket):
        ...
        """
        transaction_id, total, currency, req_card_number, card_type = self.payment_processor.handle_processor_response(
        ...
        payment_event = PaymentEvent(event_type=event_type, amount=total, reference=transaction_id,
